...
protected:
  ...
  virtual void __attribute__((noinline)) kernel1D_hash_grid_3D(float *data, int steps, int T, int F, int N, Variable A, Variable B, Variable C);                                                                
  virtual void __attribute__((noinline)) kernel1D_hash_grid_3D_coefs(float *data, int steps, int T, int N, Variable A, Variable C);
  virtual void __attribute__((noinline)) kernel1D_hash_grid_3D_backward(float *data, int steps, int T, int F, int N, Variable A, Variable B, Variable C);
